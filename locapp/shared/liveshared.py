...
username_post =  os.environ.get('POSTGRES_USER')
password_post =  os.environ.get('POSTGRES_PASS')
host_post = os.environ.get('POSTGRES_HOST')
port_post = os.environ.get('POSTGRES_PORT')
dbname_post = os.environ.get('POSTGRES_DB')
